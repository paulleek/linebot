<?php
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, array(
        'Authorization: Bearer 8k1z0DBUiRirduPeUgAs1hWfBYRAcngiBEW0UypVLBypj2KnUPCgtXsb8y0Mni3UkGcbZoEGuskctssFx5QfF4T6vjyPvpmVTVCWnzcdVkNvr5k2WzqmDXrNYPlZcnpvqgOJYLFBj145BRaW0K2z/wdB04t89/1O/w1cDnyilFU='
    ));
    ...
    $post_data = array (
        "requests" => array (
            array (
                "image" => array (
                    "source" => array (
                        "imageUri" => "https://159.65.4.103/cht20190214/paullee/".$imageId.".jpeg"
                    )
                ),
                "features" => array (
                    array (
